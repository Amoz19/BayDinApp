            ...
            <table className="table-fixed grid place-content-center m-10 border ">
                {questions.map(question => (
                    <tbody className='' key={question.questionNo}>
                        <tr className='grid grid-cols-table leading-10 bg-slate-800 text-[whitesmoke]' onClick={() => handleClick(question.questionName)} >
                            <td className='border border-r text-center'>
                                <Link
                                    to="/randomNumber"
                                    state={{ questionName: question.questionName, questionNumber: question.questionNo }}
